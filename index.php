  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        ...
        <li class="nav-item">
        <a class="nav-link" href="pay.php">order</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="about.php">About</a>
      </li>
        <li class="nav-item">
        <a class="nav-link" href="https://ads.google.com/intl/en_in/getstarted/?subid=in-en-ha-awa-bk-c-c00!o3~Cj0KCQiA99ybBhD9ARIsALvZavXytwjxwxm0XoXgpvrWFS-B6efAcgDPSE_7lveOdUm0H6Xjc9uTSGYaAizvEALw_wcB~140706620052~aud-618819227993:kwd-94527731~16862088904~592430220682&gclid=Cj0KCQiA99ybBhD9ARIsALvZavXytwjxwxm0XoXgpvrWFS-B6efAcgDPSE_7lveOdUm0H6Xjc9uTSGYaAizvEALw_wcB&gclsrc=aw.ds">Google Ads</a>
      </li>
...
<section class="m-5">
	...
	<div class="row mt-5">
		<div class="col-lg-6 col-12">
			<img src="images/DD1.jpg" class="img-fluid aboutimg" >
		</div>
		<div class="col-lg-6 col-12">
